...
${OBJECTDIR}/src/delete_functions.o: src/delete_functions.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/delete_functions.o src/delete_functions.c

${OBJECTDIR}/src/functions.o: src/functions.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/functions.o src/functions.c

${OBJECTDIR}/src/insert_functions.o: src/insert_functions.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/insert_functions.o src/insert_functions.c

${OBJECTDIR}/src/traversals.o: src/traversals.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/traversals.o src/traversals.c

${OBJECTDIR}/src/tree.o: src/tree.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tree.o src/tree.c
